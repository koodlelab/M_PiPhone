    ...
    if n < 10 and screenMode == 0:
        ...
        if screenMode == 0:
            if len(numberstring) > 0:
                ...
                print("Picking up incoming call...")
                serialport.write("AT\r")
                response = serialport.readlines(None)
        ...
        numberstring = "55334759"
    elif n == 16:
        numberstring = "21875389" 
    elif n == 15:
        pygame.quit()
        sys.exit() 
...
buttons = [
  ...
  [Button(( 30, 0, 240, 60), bg='box'),
   Button(( 300, 10, 10, 10), bg='quit',     cb=numericCallback, value=15),
   Button(( 20, 40, 50, 50), bg='1',     cb=numericCallback, value=1),
   Button(( 75, 40, 50, 50), bg='2',     cb=numericCallback, value=2),
   Button((130, 40, 50, 50), bg='3',     cb=numericCallback, value=3),
   Button((185, 40, 50, 50), bg='4',     cb=numericCallback, value=4),
   Button((240, 40, 50, 50), bg='mom',     cb=numericCallback, value=13),
   Button(( 20, 90, 50, 50), bg='5',     cb=numericCallback, value=5),
   Button(( 75, 90, 50, 50), bg='6',     cb=numericCallback, value=6),
   Button((130, 90, 50, 50), bg='7',     cb=numericCallback, value=7),
   Button((185, 90, 50, 50), bg='8',     cb=numericCallback, value=8),
   Button((240, 90, 50, 50), bg='dad',     cb=numericCallback, value=14),
   Button(( 20, 140, 50, 50), bg='9',     cb=numericCallback, value=9),
   Button(( 75, 140, 50, 50), bg='star',     cb=numericCallback, value=0),
   Button((130, 140, 50, 50), bg='0',     cb=numericCallback, value=0),
   Button((185, 140, 50, 50), bg='hash',     cb=numericCallback, value=0),
   Button((240, 140, 50, 50), bg='home',     cb=numericCallback, value=16),
   Button((210, 190, 60, 60), bg='del2',  cb=numericCallback, value=10),
   Button(( 90, 190, 60, 60), bg='call',    cb=numericCallback, value=12)],
  # Screen 1 for numeric input
  [Button(( 30,  0, 240, 60), bg='box'),
   Button(( 90, 190, 60, 60), bg='hang',    cb=numericCallback, value=12)]
]
...
while(True):
  ...
  if screenMode == 0 :
    ...
    label = myfont.render("Connecting", 1, (255,255,255))
